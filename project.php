    ...
    <div class="container-fluid hero-header bg-light py-5 mb-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 mb-3 animated slideInDown">Movies Genre</h1>
                    <nav aria-label="breadcrumb animated slideInDown">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Pages</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Movies Genre</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid w-100" style="height: 250px;" src="img/project-8.webp" alt="">
                                <a class="project-title h5 mb-0" href="img/project-8.webp" data-lightbox="project">
                                    Animation
                                </a>
                            </div>
                        </div>
